...
class DifyTestContainers:
    ...
    def start_containers_with_env(self):
        ...
        self.dify_sandbox = DockerContainer(image="criminalist/dify-sandbox:latest").with_network(self.network)
        ...
        self.dify_plugin_daemon = DockerContainer(image="criminalist/dify-plugin-daemon:0.3.0-local").with_network(
            self.network
        )
