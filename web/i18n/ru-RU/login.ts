const translation = {
  ...
  welcome: 'Добро пожаловать в AI telemetrio, пожалуйста, войдите, чтобы продолжить.',
  ...
  go: 'Перейти в ai.telemetrio.pro',
  ...
  license: {
    tip: 'Перед запуском AI telemetrio Community Edition ознакомьтесь с лицензией GitHub',
    link: 'Лицензия с открытым исходным кодом',
  },
  join: 'Присоединиться',
  joinTipStart: 'Приглашаем вас присоединиться к',
  joinTipEnd: 'команде на AI telemetrio',
  invalid: 'Ссылка истекла',
  explore: 'Изучить AI telemetrio',
  ...
  resetPasswordDesc: 'Введите адрес электронной почты, который вы использовали для регистрации, и мы отправим вам электронное письмо для сброса пароля.',
  or: 'ИЛИ',
